...
func (this *SFlowCounterSample) InitDatagram(tuple *Datagram) error {
	this.Data.Datagram.IPLength = tuple.IPLength
	this.Data.Datagram.SrcIP = tuple.SrcIP
	this.Data.Datagram.DstIP = tuple.DstIP
	this.Data.Datagram.SrcPort = tuple.SrcPort
	this.Data.Datagram.DstPort = tuple.DstPort
	return nil
}

func (this *SFlowCounterSample) InitOriginData(Payload []byte) error {
	this.Data.Type = "counter"
